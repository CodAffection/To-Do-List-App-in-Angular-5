# Angular 5 To Do List App. Using Firebase
An Angular 5 Sample Project For To Do List Application Using Firebase Project.

## Get the Code

```
$ git clone https://github.com/CodAffection/To-Do-List-App-in-Angular-5.git
$ cd To-Do-List-App-in-Angular-5/todolistapp
$ npm install
//run the app
$ ng serve
...
```
 ...
 Url : https://youtu.be/jNCzuSryJHE
